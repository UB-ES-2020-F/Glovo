    ...
    if(MediaQuery.of(context).size.width > 1000){
      return Column (mainAxisSize: MainAxisSize.min,children: [
              ...
              padding: EdgeInsets.only(bottom: 30, left: 20, right: 20),
               ...
               children: [
                 Container(width: 800, child: Expanded(child: 
                Table(   
                ...
                style: TextStyle(
                  ...
                  TableRow(
                    children: [
                      Padding(child: 
                      Text("About us", style: FooterTextNormalStyle),padding: EdgeInsets.only(bottom: 15),),
                      Text("Careers", style: FooterTextNormalStyle),
                      Text("FAQ", style: FooterTextNormalStyle),
                      Text("Terms and conditions", style: FooterTextNormalStyle),
                  ...
                  TableRow(
                    children: [
                      Padding(child: 
                      Text("", style: FooterTextNormalStyle),padding: EdgeInsets.only(bottom: 15),),
                      Text("Store Partners", style: FooterTextNormalStyle),
                      Text("Contact us", style: FooterTextNormalStyle),
                      Text("Privacy policy", style: FooterTextNormalStyle),
                  ...
                  TableRow(
                    children: [
                      ...
                      Text("Cookies Policy", style: FooterTextNormalStyle),
                  ...
                  TableRow(
                    children: [
                      Padding(child: 
                      Text("", style: FooterTextNormalStyle),padding: EdgeInsets.only(bottom: 15),),
                      Text("Glovo business", style: FooterTextNormalStyle),
                      Text("", style: FooterTextNormalStyle),
                      Text("", style: FooterTextNormalStyle),
                      Text("", style: FooterTextNormalStyle),
                    ]
              ...
              Column(mainAxisAlignment: MainAxisAlignment.start,children: [
                Container(padding: EdgeInsets.only(top: 2),height:70,child:
                    IconButton(
                        iconSize: 120,
                        icon: Image.asset(
                          'resources/images/download-button.png',
                        ))),
                                              Container(height:70,child:IconButton(
                        iconSize: 120,
                        icon: Image.asset(
...
class SampleAnimation extends StatefulWidget{
  double c;
  SampleAnimation(this.c);

  @override
  State<StatefulWidget> createState() {
    return SampleAnimationState(c);
  }
}
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Positioned(
            top: calculate(_animation.value).dy-15,
            left: calculate(_animation.value).dx-10,
            child: Transform.rotate(angle: calculate_angle(_animation.value).direction, child: IconButton(
